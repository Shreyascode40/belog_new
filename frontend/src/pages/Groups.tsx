...
export default function Groups(){
  ...
  return <div>
    <div className="flex justify-between items-center">
      ...
      <a href="/create-group" className="bg-blue-600 text-white px-4 py-2 rounded text-sm">+ Create Group</a>
    </div>
    ...
    <div className="bg-white rounded-xl border mt-6 overflow-hidden">
      <table className="w-full text-sm">
        ...
        {groups.length===0&&<tr><td colSpan={3} className="p-8 text-center text-gray-400">No groups yet — <a href="/create-group" className="text-blue-600 underline">Create a Group</a> (you'll be Member 1) or accept an invite from dashboard.</td></tr>}</tbody>
      </table>
    </div>
  </div>
}
